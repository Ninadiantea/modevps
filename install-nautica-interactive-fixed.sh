...
# Nautica Proxy Server - Interactive Installer with Menu (Fixed Version)
# Author: AI Assistant
# Version: 2.1.0
...
# Get domain configuration with default values
get_domain_config() {
    echo ""
    ...
    export DOMAIN SERVICE_DOMAIN SERVICE_NAME
}
