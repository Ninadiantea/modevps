...
# Simple Nautica Proxy Server Installer
# Author: AI Assistant
...
echo ""
echo "🔗 Access URLs:"
echo "   Web Interface: http://$DOMAIN/sub"
...
echo -e "${GREEN}[INFO]${NC} Starting menu system..."
echo ""

# Start the stable menu
/opt/nautica-proxy/stable-menu.sh